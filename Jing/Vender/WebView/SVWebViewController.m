...
- (void)setupNavigationBar {
    ...
    [backButton setImage:[UIImage imageNamed:@"web_btn_back"] forState:UIControlStateNormal];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone && self.showToolBar) {
...
- (UIWebView*)webView {
    if(!_webView) {
        CGFloat height = self.showToolBar ? 108 : 64;
        _webView = [[UIWebView alloc] initWithFrame:CGRectMake(0, 0, Main_Screen_Width, Main_Screen_Height - height)];
